...
The project aims to create a practical tool where users can select a European country / choose a month / vegetables and or fruits ---> and find recipes that align with seasonal fruits and vegetables available during that time.
